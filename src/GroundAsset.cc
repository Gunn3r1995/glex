...
GroundAsset::GroundAsset(glm::vec3 xyzPosition, glm::vec3 translateTo, glm::vec3 rotate, glm::vec3 scale) : GameAsset(xyzPosition, translateTo, rotate, scale) {
